...
##    15)  Treinamento do modelo Comaprativo em validação cruzada.
...
def plot_roc_curve(fpr, tpr):
    ...
    plt.xlabel('Taxa de falsos positovos')
...
```
    ...
    Time:                        07:24:56   Log-Likelihood:                -210.45
...
```
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x158984f0>
...
```
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x153242b0>
